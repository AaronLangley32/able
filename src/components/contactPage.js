...
import { ContactContainer, ContactContent, ContactHeader, ContentLeft, MapContainer, ContentRight, LeftHeader, LeftInfo, RightHeader, RightInfo } from '../CSS/contactPageStyles';


function Contact() {
  return (
    <ContactContainer>
      <ContactHeader>Contact & Location Information</ContactHeader>
      <ContactContent>
        <ContentLeft>
          <LeftHeader>
